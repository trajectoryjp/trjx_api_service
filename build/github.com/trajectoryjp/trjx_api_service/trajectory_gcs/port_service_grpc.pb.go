...
const (
	PortService_NotifyTakeoffCompleted_FullMethodName = "/trajectory.trajectory_gcs_service.protocol.v1.PortService/NotifyTakeoffCompleted"
	PortService_NotifyLandingCompleted_FullMethodName = "/trajectory.trajectory_gcs_service.protocol.v1.PortService/NotifyLandingCompleted"
...
type PortServiceClient interface {
	// 離陸完了通知
	NotifyTakeoffCompleted(ctx context.Context, in *NotifyCompletedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 着陸完了通知
	NotifyLandingCompleted(ctx context.Context, in *NotifyCompletedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// ポートの登録
...
func (c *portServiceClient) NotifyTakeoffCompleted(ctx context.Context, in *NotifyCompletedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PortService_NotifyTakeoffCompleted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *portServiceClient) NotifyLandingCompleted(ctx context.Context, in *NotifyCompletedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PortService_NotifyLandingCompleted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PortServiceServer interface {
	// 離陸完了通知
	NotifyTakeoffCompleted(context.Context, *NotifyCompletedRequest) (*emptypb.Empty, error)
	// 着陸完了通知
	NotifyLandingCompleted(context.Context, *NotifyCompletedRequest) (*emptypb.Empty, error)
	// ポートの登録
...
func (UnimplementedPortServiceServer) NotifyTakeoffCompleted(context.Context, *NotifyCompletedRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NotifyTakeoffCompleted not implemented")
}
func (UnimplementedPortServiceServer) NotifyLandingCompleted(context.Context, *NotifyCompletedRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NotifyLandingCompleted not implemented")
}
...
func _PortService_NotifyTakeoffCompleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotifyCompletedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PortServiceServer).NotifyTakeoffCompleted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PortService_NotifyTakeoffCompleted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PortServiceServer).NotifyTakeoffCompleted(ctx, req.(*NotifyCompletedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PortService_NotifyLandingCompleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotifyCompletedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PortServiceServer).NotifyLandingCompleted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PortService_NotifyLandingCompleted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PortServiceServer).NotifyLandingCompleted(ctx, req.(*NotifyCompletedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PortService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NotifyTakeoffCompleted",
			Handler:    _PortService_NotifyTakeoffCompleted_Handler,
		},
		{
			MethodName: "NotifyLandingCompleted",
			Handler:    _PortService_NotifyLandingCompleted_Handler,
		},
		{
