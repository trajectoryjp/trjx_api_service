...
// Type
type ItemParameter_Waypoint_Type int32

const (
	ItemParameter_Waypoint_GENERAL  ItemParameter_Waypoint_Type = 0 // 通常のROI
	ItemParameter_Waypoint_ROAD_ROI ItemParameter_Waypoint_Type = 1 // RoadROIにより生成されたWaypoint
)

// Enum value maps for ItemParameter_Waypoint_Type.
var (
	ItemParameter_Waypoint_Type_name = map[int32]string{
		0: "GENERAL",
		1: "ROAD_ROI",
	}
	ItemParameter_Waypoint_Type_value = map[string]int32{
		"GENERAL":  0,
		"ROAD_ROI": 1,
	}
)

func (x ItemParameter_Waypoint_Type) Enum() *ItemParameter_Waypoint_Type {
	p := new(ItemParameter_Waypoint_Type)
	*p = x
	return p
}

func (x ItemParameter_Waypoint_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ItemParameter_Waypoint_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_enumTypes[4].Descriptor()
}

func (ItemParameter_Waypoint_Type) Type() protoreflect.EnumType {
	return &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_enumTypes[4]
}

func (x ItemParameter_Waypoint_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ItemParameter_Waypoint_Type.Descriptor instead.
func (ItemParameter_Waypoint_Type) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{4, 0}
}
...
const (
	ItemParameter_Land_LAND_MODE_UNSPECIFIED ItemParameter_Land_LandMode = 0
	ItemParameter_Land_DEFAULT               ItemParameter_Land_LandMode = 10 // 機体の種別により自動でモードを決定する
	ItemParameter_Land_TAKEOFF_POINT         ItemParameter_Land_LandMode = 1  // 離陸地点に戻って着陸する。（緯度、経度の指定は無視される）
	ItemParameter_Land_RTL                   ItemParameter_Land_LandMode = 2  // RTLに指定された位置へ着陸する。（緯度、経度の指定は無視される）
	ItemParameter_Land_CURRENT               ItemParameter_Land_LandMode = 3  // 緯度、経度で指定した位置に着陸する。
	ItemParameter_Land_TRACKING              ItemParameter_Land_LandMode = 4  // トラッキングで与える場所に着陸（実装予定）（緯度、経度の指定は無視される）
)
...
func (Mission_EtaAttr) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{14, 0}
}
...
func (MissionItem_ItemAttr) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{15, 0}
}
...
func (MissionItem_SafetyRoute) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{15, 1}
}
...
func (CameraControl_ControlMode) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{18, 0}
}
...
func (CameraControl_PictureControl) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{18, 1}
}
...
func (CameraControl_MovieControl) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{18, 2}
}
...
func (CameraControl_ImageMode) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{18, 3}
}
...
func (CameraControl_RayMode) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{18, 4}
}
...
func (ItemParameterWaypoint_Type) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{19, 0}
}
...
const (
	...
	// 機体の種別により自動でモードを決定する
	ItemParameterLand_DEFAULT ItemParameterLand_LandMode = 10
	// 離陸地点に戻って着陸する。（緯度、経度の指定は無視される）
	ItemParameterLand_TAKEOFF_POINT ItemParameterLand_LandMode = 1
	// RTLに指定された位置へ着陸する。（緯度、経度の指定は無視される）
	ItemParameterLand_RTL ItemParameterLand_LandMode = 2
	// 緯度、経度で指定した位置に着陸する。
	ItemParameterLand_CURRENT ItemParameterLand_LandMode = 3
	// トラッキングで与える場所に着陸（実装予定）（緯度、経度の指定は無視される）
	ItemParameterLand_TRAKING ItemParameterLand_LandMode = 4
)
...
func (ItemParameterLand_LandMode) Descriptor() protoreflect.EnumDescriptor {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_enumTypes[17].Descriptor()
}

func (ItemParameterLand_LandMode) Type() protoreflect.EnumType {
	return &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_enumTypes[17]
}
...
func (ItemParameterLand_LandMode) EnumDescriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{20, 0}
}
...
func (x *ItemParameter_Takeoff) GetTagOfGroup() string {
	if x != nil {
		return x.TagOfGroup
	}
	return ""
...
func (x *ItemParameter_ROI) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_ROI) ProtoMessage() {}

func (x *ItemParameter_ROI) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_ROI.ProtoReflect.Descriptor instead.
func (*ItemParameter_ROI) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{3}
}

func (x *ItemParameter_ROI) GetLatitude() float64 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *ItemParameter_ROI) GetLongitude() float64 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
type ItemParameter_Waypoint struct {
	...
	// ROIグループ名
	TagOfGroup string `protobuf:"bytes,1,opt,name=tag_of_group,json=tagOfGroup,proto3" json:"tag_of_group,omitempty"` // heading設定時は無効
	// 緯度
	Latitude float64 `protobuf:"fixed64,3,opt,name=latitude,proto3" json:"latitude,omitempty"`
	// 経度
	Longitude float64 `protobuf:"fixed64,4,opt,name=longitude,proto3" json:"longitude,omitempty"`
	...
	// 次のWaypointへのルートの属性
	SafetyRouteAttr MissionItem_SafetyRoute `protobuf:"varint,7,opt,name=safety_route_attr,json=safetyRouteAttr,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.MissionItem_SafetyRoute" json:"safety_route_attr,omitempty"` //（入力ではdon't care）
	// trueで無限pause（再開メッセージを受けるまで）
	Pause bool `protobuf:"varint,10,opt,name=pause,proto3" json:"pause,omitempty"`
	// pauseがfalseの場合のみ有効。秒
	HoldTime float32 `protobuf:"fixed32,11,opt,name=hold_time,json=holdTime,proto3" json:"hold_time,omitempty"`
	// ヘディング
	Heading *ItemParameter_Waypoint_HeadingAngle `protobuf:"bytes,12,opt,name=heading,proto3" json:"heading,omitempty"` // 指定なしの場合は進行方向。heading設定でROI（tagOfGroup）はキャンセル。
	// スピード（本WP通過後の速度)
	Speed *ItemParameter_Waypoint_SpeedDef `protobuf:"bytes,13,opt,name=speed,proto3" json:"speed,omitempty"`
	// Attr attr = 20;
	...
	CameraControl []*CameraControl     `protobuf:"bytes,41,rep,name=camera_control,json=cameraControl,proto3" json:"camera_control,omitempty"` //角度は絶対値指定（absolute）のみ許容。重複不可。
	// Types that are assignable to CameraOption:
	//
	//	*ItemParameter_Waypoint_AutoShoot
	...
	WaypointType ItemParameter_Waypoint_Type           `protobuf:"varint,21,opt,name=waypoint_type,json=waypointType,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint_Type" json:"waypoint_type,omitempty"`
}
...
func (x *ItemParameter_Waypoint) GetTagOfGroup() string {
	if x != nil {
		return x.TagOfGroup
	}
	return ""
...
func (x *ItemParameter_Waypoint) GetEta() int64 {
	if x != nil {
		return x.Eta
	}
	return 0
...
func (x *ItemParameter_Waypoint) GetSafetyRouteAttr() MissionItem_SafetyRoute {
	if x != nil {
...
func (x *ItemParameter_Waypoint) GetHeading() *ItemParameter_Waypoint_HeadingAngle {
	if x != nil {
		return x.Heading
	}
	return nil
...
func (x *ItemParameter_Waypoint) GetSpeed() *ItemParameter_Waypoint_SpeedDef {
	if x != nil {
		return x.Speed
	}
	return nil
...
func (x *ItemParameter_Waypoint) GetAttr() MissionItem_ItemAttr {
	if x != nil {
		return x.Attr
	}
...
func (x *ItemParameter_Waypoint) GetAutoShoot() bool {
	if x, ok := x.GetCameraOption().(*ItemParameter_Waypoint_AutoShoot); ok {
		return x.AutoShoot
	}
	return false
}
...
func (x *ItemParameter_Waypoint) GetWaypointType() ItemParameter_Waypoint_Type {
	if x != nil {
		return x.WaypointType
	}
	return ItemParameter_Waypoint_GENERAL
}
...
type ItemParameter_Waypoint_AutoShoot struct {
	AutoShoot bool `protobuf:"varint,42,opt,name=auto_shoot,json=autoShoot,proto3,oneof"` // ROIが設定されていてもfalseの場合はシャッターを切らない。trueの場合はROIが設定されているとシャッターを切る。
}

type ItemParameter_Waypoint_ShootIntervalDistance struct {
	// CameraCommandのshutterはROIとは独立なシャッター制御。（重複しても切るシャッターイベントは1つ）
	ShootIntervalDistance float32 `protobuf:"fixed32,43,opt,name=shoot_interval_distance,json=shootIntervalDistance,proto3,oneof"` // 写真の撮影間隔（m）。0以下で停止。
}

type ItemParameter_Waypoint_ShootIntervalTime struct {
	ShootIntervalTime int32 `protobuf:"varint,44,opt,name=shoot_interval_time,json=shootIntervalTime,proto3,oneof"` // 写真の撮影間隔（秒）。0以下で停止。
}

func (*ItemParameter_Waypoint_AutoShoot) isItemParameter_Waypoint_CameraOption() {}
...
// 離陸地点のWaypointへ向かう
type ItemParameter_TakeoffPoint struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	SafetyRouteAttr   MissionItem_SafetyRoute                  `protobuf:"varint,7,opt,name=safety_route_attr,json=safetyRouteAttr,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.MissionItem_SafetyRoute" json:"safety_route_attr,omitempty"` // 入力ではdon't care）
	HoldTime          float32                                  `protobuf:"fixed32,11,opt,name=hold_time,json=holdTime,proto3" json:"hold_time,omitempty"`
	ManualCameraShoot bool                                     `protobuf:"varint,40,opt,name=manual_camera_shoot,json=manualCameraShoot,proto3" json:"manual_camera_shoot,omitempty"`
	CameraControl     []*CameraControl                         `protobuf:"bytes,41,rep,name=camera_control,json=cameraControl,proto3" json:"camera_control,omitempty"`
	Heading           *ItemParameter_TakeoffPoint_HeadingAngle `protobuf:"bytes,12,opt,name=heading,proto3" json:"heading,omitempty"` // 指定なしの場合は進行方向。heading設定でROI（tagOfGroup）はキャンセル。
	// スピード（本WP通過後の速度）
	Speed *ItemParameter_TakeoffPoint_SpeedDef `protobuf:"bytes,13,opt,name=speed,proto3" json:"speed,omitempty"`
	// Types that are assignable to CameraOption:
	//
	//	*ItemParameter_TakeoffPoint_AutoShoot
	//	*ItemParameter_TakeoffPoint_ShootIntervalDistance
	//	*ItemParameter_TakeoffPoint_ShootIntervalTime
	CameraOption isItemParameter_TakeoffPoint_CameraOption `protobuf_oneof:"CameraOption"`
}

func (x *ItemParameter_TakeoffPoint) Reset() {
	*x = ItemParameter_TakeoffPoint{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_TakeoffPoint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_TakeoffPoint) ProtoMessage() {}

func (x *ItemParameter_TakeoffPoint) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_TakeoffPoint.ProtoReflect.Descriptor instead.
func (*ItemParameter_TakeoffPoint) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{5}
}

func (x *ItemParameter_TakeoffPoint) GetTagOfGroup() string {
	if x != nil {
		return x.TagOfGroup
	}
	return ""
...
func (x *ItemParameter_TakeoffPoint) GetEta() int64 {
	if x != nil {
		return x.Eta
	}
	return 0
...
func (x *ItemParameter_TakeoffPoint) GetSafetyRouteAttr() MissionItem_SafetyRoute {
	if x != nil {
		return x.SafetyRouteAttr
	}
	return MissionItem_SAFTY_ROUTE_UNSPECIFIED
...
func (x *ItemParameter_TakeoffPoint) GetHoldTime() float32 {
	if x != nil {
		return x.HoldTime
	}
	return 0
...
func (x *ItemParameter_TakeoffPoint) GetManualCameraShoot() bool {
	if x != nil {
		return x.ManualCameraShoot
	}
	return false
}

func (x *ItemParameter_TakeoffPoint) GetCameraControl() []*CameraControl {
	if x != nil {
		return x.CameraControl
	}
	return nil
...
func (x *ItemParameter_TakeoffPoint) GetHeading() *ItemParameter_TakeoffPoint_HeadingAngle {
	if x != nil {
		return x.Heading
	}
	return nil
...
func (x *ItemParameter_TakeoffPoint) GetSpeed() *ItemParameter_TakeoffPoint_SpeedDef {
	if x != nil {
		return x.Speed
	}
	return nil
...
func (m *ItemParameter_TakeoffPoint) GetCameraOption() isItemParameter_TakeoffPoint_CameraOption {
	if m != nil {
		return m.CameraOption
	}
	return nil
...
func (x *ItemParameter_TakeoffPoint) GetAutoShoot() bool {
	if x, ok := x.GetCameraOption().(*ItemParameter_TakeoffPoint_AutoShoot); ok {
		return x.AutoShoot
	}
	return false
}

func (x *ItemParameter_TakeoffPoint) GetShootIntervalDistance() float32 {
	if x, ok := x.GetCameraOption().(*ItemParameter_TakeoffPoint_ShootIntervalDistance); ok {
		return x.ShootIntervalDistance
	}
	return 0
}

func (x *ItemParameter_TakeoffPoint) GetShootIntervalTime() int32 {
	if x, ok := x.GetCameraOption().(*ItemParameter_TakeoffPoint_ShootIntervalTime); ok {
		return x.ShootIntervalTime
	}
	return 0
}

type isItemParameter_TakeoffPoint_CameraOption interface {
	isItemParameter_TakeoffPoint_CameraOption()
}

type ItemParameter_TakeoffPoint_AutoShoot struct {
	AutoShoot bool `protobuf:"varint,42,opt,name=auto_shoot,json=autoShoot,proto3,oneof"` // ROIが設定されていてもfalseの場合はシャッターを切らない。trueの場合はROIが設定されているとシャッターを切る。
}

type ItemParameter_TakeoffPoint_ShootIntervalDistance struct {
	// CameraCommandのshutterはROIとは独立なシャッター制御。（重複しても切るシャッターイベントは1つ）
	ShootIntervalDistance float32 `protobuf:"fixed32,43,opt,name=shoot_interval_distance,json=shootIntervalDistance,proto3,oneof"` // 写真の撮影間隔（m）。0以下で停止。
}

type ItemParameter_TakeoffPoint_ShootIntervalTime struct {
	ShootIntervalTime int32 `protobuf:"varint,44,opt,name=shoot_interval_time,json=shootIntervalTime,proto3,oneof"` // 写真の撮影間隔（秒）。0以下で停止。
}

func (*ItemParameter_TakeoffPoint_AutoShoot) isItemParameter_TakeoffPoint_CameraOption() {}

func (*ItemParameter_TakeoffPoint_ShootIntervalDistance) isItemParameter_TakeoffPoint_CameraOption() {
}

func (*ItemParameter_TakeoffPoint_ShootIntervalTime) isItemParameter_TakeoffPoint_CameraOption() {}
...
func (x *ItemParameter_Land) GetMode() ItemParameter_Land_LandMode {
	...
	return ItemParameter_Land_LAND_MODE_UNSPECIFIED
}

func (x *ItemParameter_Land) GetTagOfGroup() string {
	if x != nil {
		return x.TagOfGroup
	}
	return ""
...
func (x *ItemParameter_Land) GetAttr() MissionItem_ItemAttr {
	if x != nil {
		return x.Attr
	}
	return MissionItem_ITEM_ATTR_UNSPECIFIED
...
// Waypointのspeedを推奨
type ItemParameter_Speed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Speed float32              `protobuf:"fixed32,1,opt,name=speed,proto3" json:"speed,omitempty"` // m/sec
	Attr  MissionItem_ItemAttr `protobuf:"varint,20,opt,name=attr,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.MissionItem_ItemAttr" json:"attr,omitempty"`
}

func (x *ItemParameter_Speed) Reset() {
	*x = ItemParameter_Speed{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_Speed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_Speed) ProtoMessage() {}

func (x *ItemParameter_Speed) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_Speed.ProtoReflect.Descriptor instead.
func (*ItemParameter_Speed) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{7}
}

func (x *ItemParameter_Speed) GetSpeed() float32 {
	if x != nil {
		return x.Speed
	}
	return 0
...
func (x *ItemParameter_Speed) GetAttr() MissionItem_ItemAttr {
	if x != nil {
		return x.Attr
	}
	return MissionItem_ITEM_ATTR_UNSPECIFIED
...
func (x *ItemParameter_Yaw) Reset() {
	*x = ItemParameter_Yaw{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_Yaw) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_Yaw) ProtoMessage() {}

func (x *ItemParameter_Yaw) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_Yaw.ProtoReflect.Descriptor instead.
func (*ItemParameter_Yaw) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{8}
}

func (x *ItemParameter_Yaw) GetAngle() float32 {
	if x != nil {
		return x.Angle
	}
	return 0
...
func (x *ItemParameter_Yaw) GetAttr() MissionItem_ItemAttr {
	if x != nil {
		return x.Attr
	}
	return MissionItem_ITEM_ATTR_UNSPECIFIED
...
// 入力には指定しない
// 遅延時間を指定する。
type ItemParameter_Delay struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ItemParameter_Delay) Reset() {
	*x = ItemParameter_Delay{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_Delay) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_Delay) ProtoMessage() {}

func (x *ItemParameter_Delay) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_Delay.ProtoReflect.Descriptor instead.
func (*ItemParameter_Delay) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{9}
}

func (x *ItemParameter_Delay) GetDelaySec() int32 {
	if x != nil {
		return x.DelaySec
	}
	return 0
...
func (x *ItemParameter_Delay) GetAttr() MissionItem_ItemAttr {
	if x != nil {
		return x.Attr
	}
	return MissionItem_ITEM_ATTR_UNSPECIFIED
...
// 入力には指定しない
// ARM/DISARMする。
type ItemParameter_Arm struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Arm  bool                 `protobuf:"varint,1,opt,name=arm,proto3" json:"arm,omitempty"` // trueでARM。falseでDISARM
	Attr MissionItem_ItemAttr `protobuf:"varint,20,opt,name=attr,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.MissionItem_ItemAttr" json:"attr,omitempty"`
}

func (x *ItemParameter_Arm) Reset() {
	*x = ItemParameter_Arm{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_Arm) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_Arm) ProtoMessage() {}

func (x *ItemParameter_Arm) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_Arm.ProtoReflect.Descriptor instead.
func (*ItemParameter_Arm) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{10}
}

func (x *ItemParameter_Arm) GetArm() bool {
	if x != nil {
		return x.Arm
	}
	return false
...
func (x *ItemParameter_Arm) GetAttr() MissionItem_ItemAttr {
	if x != nil {
		return x.Attr
	}
	return MissionItem_ITEM_ATTR_UNSPECIFIED
...
type ItemParameterLand struct {
	...
	Mode ItemParameterLand_LandMode `protobuf:"varint,8,opt,name=mode,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand_LandMode" json:"mode,omitempty"`
	// ROIグループ名
	...
	Attr     *MissionItem_ItemAttr `protobuf:"varint,20,opt,name=attr,proto3,enum=trajectory.trajectory_gcs_service.protocol.v1.MissionItem_ItemAttr,oneof" json:"attr,omitempty"`
}
...
func (x *ItemParameterLand) GetMode() ItemParameterLand_LandMode {
	if x != nil {
		return x.Mode
	}
...
func (*KML) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{33}
}
...
func (*PortHeader) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{34}
}
...
func (*Port) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{35}
}
...
func (*PortLocation) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{37}
}
...
func (*ResultPathForPlan) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{38}
}
...
func (*Spot) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{39}
}
...
type ItemParameter_Waypoint_HeadingAngle struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Degree float32 `protobuf:"fixed32,1,opt,name=degree,proto3" json:"degree,omitempty"` // 度。絶対角度、北が0度。
}

func (x *ItemParameter_Waypoint_HeadingAngle) Reset() {
	*x = ItemParameter_Waypoint_HeadingAngle{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_Waypoint_HeadingAngle) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_Waypoint_HeadingAngle) ProtoMessage() {}

func (x *ItemParameter_Waypoint_HeadingAngle) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_Waypoint_HeadingAngle.ProtoReflect.Descriptor instead.
func (*ItemParameter_Waypoint_HeadingAngle) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{4, 0}
}

func (x *ItemParameter_Waypoint_HeadingAngle) GetDegree() float32 {
	if x != nil {
		return x.Degree
	}
	return 0
...
type ItemParameter_Waypoint_SpeedDef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Speed float32 `protobuf:"fixed32,1,opt,name=speed,proto3" json:"speed,omitempty"` // m/s
}

func (x *ItemParameter_Waypoint_SpeedDef) Reset() {
	*x = ItemParameter_Waypoint_SpeedDef{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_Waypoint_SpeedDef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_Waypoint_SpeedDef) ProtoMessage() {}

func (x *ItemParameter_Waypoint_SpeedDef) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[41]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_Waypoint_SpeedDef.ProtoReflect.Descriptor instead.
func (*ItemParameter_Waypoint_SpeedDef) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{4, 1}
}

func (x *ItemParameter_Waypoint_SpeedDef) GetSpeed() float32 {
	if x != nil {
		return x.Speed
	}
	return 0
...
type ItemParameter_TakeoffPoint_HeadingAngle struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ItemParameter_TakeoffPoint_HeadingAngle) Reset() {
	*x = ItemParameter_TakeoffPoint_HeadingAngle{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_TakeoffPoint_HeadingAngle) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_TakeoffPoint_HeadingAngle) ProtoMessage() {}

func (x *ItemParameter_TakeoffPoint_HeadingAngle) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_TakeoffPoint_HeadingAngle.ProtoReflect.Descriptor instead.
func (*ItemParameter_TakeoffPoint_HeadingAngle) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{5, 0}
}

func (x *ItemParameter_TakeoffPoint_HeadingAngle) GetDegree() float32 {
	if x != nil {
		return x.Degree
	}
	return 0
...
type ItemParameter_TakeoffPoint_SpeedDef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ItemParameter_TakeoffPoint_SpeedDef) Reset() {
	*x = ItemParameter_TakeoffPoint_SpeedDef{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemParameter_TakeoffPoint_SpeedDef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemParameter_TakeoffPoint_SpeedDef) ProtoMessage() {}

func (x *ItemParameter_TakeoffPoint_SpeedDef) ProtoReflect() protoreflect.Message {
	mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemParameter_TakeoffPoint_SpeedDef.ProtoReflect.Descriptor instead.
func (*ItemParameter_TakeoffPoint_SpeedDef) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{5, 1}
}

func (x *ItemParameter_TakeoffPoint_SpeedDef) GetSpeed() float32 {
	if x != nil {
		return x.Speed
	}
	return 0
...
func (*SolidModel_PolygonalPillar) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{31, 0}
}
...
func (x *SolidModel_PolygonalPyramid) Reset() {
	*x = SolidModel_PolygonalPyramid{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[48]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolidModel_PolygonalPyramid) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{31, 1}
}
...
func (x *SolidModel_Column) Reset() {
	*x = SolidModel_Column{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[49]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolidModel_Column) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{31, 2}
}
...
func (x *SolidModel_Cone) Reset() {
	*x = SolidModel_Cone{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[50]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolidModel_Cone) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{31, 3}
}
...
func (x *SolidModel_RightTrianglePillar) Reset() {
	*x = SolidModel_RightTrianglePillar{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[51]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SolidModel_RightTrianglePillar) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{31, 4}
}
...
func (x *ResultPathForPlan_Path) Reset() {
	*x = ResultPathForPlan_Path{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[52]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResultPathForPlan_Path) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{38, 0}
}
...
func (x *ResultPathForPlan_InBarrierError) Reset() {
	*x = ResultPathForPlan_InBarrierError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[53]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResultPathForPlan_InBarrierError) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{38, 1}
}
...
func (x *ResultPathForPlan_InNoDataError) Reset() {
	*x = ResultPathForPlan_InNoDataError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[54]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResultPathForPlan_InNoDataError) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{38, 2}
}
...
func (x *ResultPathForPlan_NoPathError) Reset() {
	*x = ResultPathForPlan_NoPathError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[55]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResultPathForPlan_NoPathError) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{38, 3}
}
...
func (x *ResultPathForPlan_UnreachableError) Reset() {
	*x = ResultPathForPlan_UnreachableError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[56]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ResultPathForPlan_UnreachableError) Descriptor() ([]byte, []int) {
	return file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDescGZIP(), []int{38, 4}
}
...
var file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x12, 0x41, 0x0a, 0x08, 0x61, 0x6c, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x05, 0x20,
	...
	0x74, 0x75, 0x64, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x74, 0x61, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x03, 0x65, 0x74, 0x61, 0x12, 0x72, 0x0a, 0x11, 0x73, 0x61, 0x66, 0x65, 0x74, 0x79,
	0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x46, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x74,
	...
	0x31, 0x2e, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x74, 0x65, 0x6d, 0x2e, 0x53, 0x61,
	0x66, 0x65, 0x74, 0x79, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x0f, 0x73, 0x61, 0x66, 0x65, 0x74,
	0x79, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x41, 0x74, 0x74, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x61,
	0x75, 0x73, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x70, 0x61, 0x75, 0x73, 0x65,
	0x12, 0x1b, 0x0a, 0x09, 0x68, 0x6f, 0x6c, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x02, 0x52, 0x08, 0x68, 0x6f, 0x6c, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x6c, 0x0a,
	0x07, 0x68, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x52,
	...
	0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x57, 0x61, 0x79,
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x41, 0x6e, 0x67,
	0x6c, 0x65, 0x52, 0x07, 0x68, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x12, 0x64, 0x0a, 0x05, 0x73,
	0x70, 0x65, 0x65, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x4e, 0x2e, 0x74, 0x72, 0x61,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x57, 0x61, 0x79, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x2e, 0x53, 0x70, 0x65, 0x65, 0x64, 0x44, 0x65, 0x66, 0x52, 0x05, 0x73, 0x70, 0x65, 0x65,
	0x64, 0x12, 0x57, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x4d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x74, 0x65, 0x6d, 0x2e, 0x49, 0x74, 0x65, 0x6d,
	0x41, 0x74, 0x74, 0x72, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x12, 0x63, 0x0a, 0x0e, 0x63, 0x61,
	0x6d, 0x65, 0x72, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x18, 0x29, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x2e,
	...
	,
	...
	,
	...
	0x74, 0x75, 0x64, 0x65, 0x52, 0x08, 0x61, 0x6c, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x12, 0x10,
	0x0a, 0x03, 0x65, 0x74, 0x61, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x65, 0x74, 0x61,
	0x12, 0x72, 0x0a, 0x11, 0x73, 0x61, 0x66, 0x65, 0x74, 0x79, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65,
	0x5f, 0x61, 0x74, 0x74, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x46, 0x2e, 0x74, 0x72,
	...
	,
	...
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x12, 0x70, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x69, 0x6e,
	0x67, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x56, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63,
	...
	,
	...
	,
	...
	0x63, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x74,
	0x65, 0x6d, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x41, 0x74, 0x74, 0x72, 0x52, 0x04, 0x61, 0x74, 0x74,
	0x72, 0x22, 0x8b, 0x01, 0x0a, 0x13, 0x49, 0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65,
	0x74, 0x65, 0x72, 0x5f, 0x44, 0x65, 0x6c, 0x61, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x64, 0x65, 0x6c,
	0x61, 0x79, 0x5f, 0x73, 0x65, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x64, 0x65,
	0x6c, 0x61, 0x79, 0x53, 0x65, 0x63, 0x12, 0x57, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x1e,
	...
	0x7e, 0x0a, 0x11, 0x49, 0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72,
	0x5f, 0x41, 0x72, 0x6d, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x72, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x03, 0x61, 0x72, 0x6d, 0x12, 0x57, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72, 0x18, 0x14,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x43, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74, 0x6f, 0x72,
	0x79, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x67, 0x63, 0x73,
	0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x74, 0x65, 0x6d,
	...
	0x74, 0x65, 0x72, 0x22, 0xad, 0x01, 0x0a, 0x14, 0x49, 0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x54, 0x61, 0x6b, 0x65, 0x6f, 0x66, 0x66, 0x12, 0x1f, 0x0a, 0x0b,
	0x74, 0x61, 0x67, 0x6f, 0x66, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x74, 0x61, 0x67, 0x6f, 0x66, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x46, 0x0a,
	...
	0x78, 0x5f, 0x61, 0x70, 0x69, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x41, 0x6c,
	0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x48, 0x00, 0x52, 0x08, 0x61, 0x6c, 0x74, 0x69, 0x74, 0x75,
	0x64, 0x65, 0x88, 0x01, 0x01, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x61, 0x6c, 0x74, 0x69, 0x74, 0x75,
	0x64, 0x65, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x52, 0x08,
	0x6c, 0x61, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74,
	0x75, 0x64, 0x65, 0x22, 0x8f, 0x01, 0x0a, 0x10, 0x49, 0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x4f, 0x49, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61, 0x74, 0x69,
	...
	0x64, 0x65, 0x12, 0x41, 0x0a, 0x08, 0x61, 0x6c, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x05,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x6d, 0x41, 0x74, 0x74, 0x72, 0x52, 0x04, 0x61, 0x74, 0x74, 0x72, 0x22, 0x81, 0x01,
	0x0a, 0x10, 0x49, 0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x59,
	0x61, 0x77, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6e, 0x67, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x05, 0x61, 0x6e, 0x67, 0x6c, 0x65, 0x12, 0x57, 0x0a, 0x04, 0x61, 0x74, 0x74, 0x72,
	0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x43, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x79, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x67,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x22, 0x94, 0x09, 0x0a, 0x0a, 0x53, 0x6f, 0x6c, 0x69, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	0x12, 0x3d, 0x0a, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	,
	...
	0x09, 0x5f, 0x65, 0x6e, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x22, 0xdc, 0x02, 0x0a, 0x04, 0x50,
	0x6f, 0x72, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x29, 0x0a, 0x10, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x6f,
	0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x49, 0x64, 0x12, 0x19,
	...
	,
	...
	0x61, 0x67, 0x12, 0x48, 0x0a, 0x0c, 0x75, 0x61, 0x76, 0x5f, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x74, 0x72, 0x61, 0x6a, 0x65,
	...
	,
	...
	0x12, 0x56, 0x0a, 0x05, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x6e, 0x52, 0x05, 0x70, 0x61, 0x74, 0x68, 0x73, 0x22, 0xb6, 0x0c, 0x0a, 0x11, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x50, 0x61, 0x74, 0x68, 0x46, 0x6f, 0x72, 0x50, 0x6c, 0x61, 0x6e, 0x12, 0x1c,
	0x0a, 0x09, 0x63, 0x6c, 0x65, 0x61, 0x72, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x09, 0x63, 0x6c, 0x65, 0x61, 0x72, 0x61, 0x6e, 0x63, 0x65, 0x12, 0x1d, 0x0a, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x74, 0x72, 0x61, 0x6a, 0x65, 0x63, 0x74, 0x6f, 0x72,
	0x79, 0x5f, 0x67, 0x63, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_enumTypes = make([]protoimpl.EnumInfo, 18)
var file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_goTypes = []any{
	...
	(TransactionID_Attribute)(0),                    // 3: trajectory.trajectory_gcs_service.protocol.v1.TransactionID.Attribute
	(ItemParameter_Waypoint_Type)(0),                // 4: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.Type
	(ItemParameter_Land_LandMode)(0),                // 5: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Land.LandMode
	(ExternalMission_Format)(0),                     // 6: trajectory.trajectory_gcs_service.protocol.v1.ExternalMission.Format
	(MissionControllerResult_Status)(0),             // 7: trajectory.trajectory_gcs_service.protocol.v1.MissionControllerResult.Status
	(Mission_EtaAttr)(0),                            // 8: trajectory.trajectory_gcs_service.protocol.v1.Mission.EtaAttr
	(MissionItem_ItemAttr)(0),                       // 9: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	(MissionItem_SafetyRoute)(0),                    // 10: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.SafetyRoute
	(CameraControl_ControlMode)(0),                  // 11: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ControlMode
	(CameraControl_PictureControl)(0),               // 12: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.PictureControl
	(CameraControl_MovieControl)(0),                 // 13: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.MovieControl
	(CameraControl_ImageMode)(0),                    // 14: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ImageMode
	(CameraControl_RayMode)(0),                      // 15: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.RayMode
	(ItemParameterWaypoint_Type)(0),                 // 16: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.Type
	(ItemParameterLand_LandMode)(0),                 // 17: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand.LandMode
	(*TransactionID)(nil),                           // 18: trajectory.trajectory_gcs_service.protocol.v1.TransactionID
	(*ScheduledTime)(nil),                           // 19: trajectory.trajectory_gcs_service.protocol.v1.ScheduledTime
	(*ItemParameter_Takeoff)(nil),                   // 20: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Takeoff
	(*ItemParameter_ROI)(nil),                       // 21: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_ROI
	(*ItemParameter_Waypoint)(nil),                  // 22: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint
	(*ItemParameter_TakeoffPoint)(nil),              // 23: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint
	(*ItemParameter_Land)(nil),                      // 24: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Land
	(*ItemParameter_Speed)(nil),                     // 25: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Speed
	(*ItemParameter_Yaw)(nil),                       // 26: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Yaw
	(*ItemParameter_Delay)(nil),                     // 27: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Delay
	(*ItemParameter_Arm)(nil),                       // 28: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Arm
	(*ExternalMission)(nil),                         // 29: trajectory.trajectory_gcs_service.protocol.v1.ExternalMission
	(*MissionControllerResult)(nil),                 // 30: trajectory.trajectory_gcs_service.protocol.v1.MissionControllerResult
	(*ApplicationAttr)(nil),                         // 31: trajectory.trajectory_gcs_service.protocol.v1.ApplicationAttr
	(*Mission)(nil),                                 // 32: trajectory.trajectory_gcs_service.protocol.v1.Mission
	(*MissionItem)(nil),                             // 33: trajectory.trajectory_gcs_service.protocol.v1.MissionItem
	(*ItemParameterTakeoff)(nil),                    // 34: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterTakeoff
	(*ItemParameterROI)(nil),                        // 35: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterROI
	(*CameraControl)(nil),                           // 36: trajectory.trajectory_gcs_service.protocol.v1.CameraControl
	(*ItemParameterWaypoint)(nil),                   // 37: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint
	(*ItemParameterLand)(nil),                       // 38: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand
	(*ItemParameterSpeed)(nil),                      // 39: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterSpeed
	(*ItemParameterYaw)(nil),                        // 40: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterYaw
	(*ItemParameterDelay)(nil),                      // 41: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterDelay
	(*ROI)(nil),                                     // 42: trajectory.trajectory_gcs_service.protocol.v1.ROI
	(*OragnizationID)(nil),                          // 43: trajectory.trajectory_gcs_service.protocol.v1.OragnizationID
	(*MissionID)(nil),                               // 44: trajectory.trajectory_gcs_service.protocol.v1.MissionID
	(*ProjectID)(nil),                               // 45: trajectory.trajectory_gcs_service.protocol.v1.ProjectID
	(*UAVID)(nil),                                   // 46: trajectory.trajectory_gcs_service.protocol.v1.UAVID
	(*Key)(nil),                                     // 47: trajectory.trajectory_gcs_service.protocol.v1.Key
	(*OptionalTimeStamp)(nil),                       // 48: trajectory.trajectory_gcs_service.protocol.v1.OptionalTimeStamp
	(*SolidModel)(nil),                              // 49: trajectory.trajectory_gcs_service.protocol.v1.SolidModel
	(*Cartesian2D)(nil),                             // 50: trajectory.trajectory_gcs_service.protocol.v1.Cartesian2D
	(*KML)(nil),                                     // 51: trajectory.trajectory_gcs_service.protocol.v1.KML
	(*PortHeader)(nil),                              // 52: trajectory.trajectory_gcs_service.protocol.v1.PortHeader
	(*Port)(nil),                                    // 53: trajectory.trajectory_gcs_service.protocol.v1.Port
	(*SearchSpace)(nil),                             // 54: trajectory.trajectory_gcs_service.protocol.v1.SearchSpace
	(*PortLocation)(nil),                            // 55: trajectory.trajectory_gcs_service.protocol.v1.PortLocation
	(*ResultPathForPlan)(nil),                       // 56: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan
	(*Spot)(nil),                                    // 57: trajectory.trajectory_gcs_service.protocol.v1.Spot
	(*ItemParameter_Waypoint_HeadingAngle)(nil),     // 58: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.HeadingAngle
	(*ItemParameter_Waypoint_SpeedDef)(nil),         // 59: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.SpeedDef
	(*ItemParameter_TakeoffPoint_HeadingAngle)(nil), // 60: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.HeadingAngle
	(*ItemParameter_TakeoffPoint_SpeedDef)(nil),     // 61: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.SpeedDef
	(*CameraControl_Angle)(nil),                     // 62: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.Angle
	(*CameraControl_ZoomControl)(nil),               // 63: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ZoomControl
	(*ROI_RoadROI)(nil),                             // 64: trajectory.trajectory_gcs_service.protocol.v1.ROI.RoadROI
	(*SolidModel_PolygonalPillar)(nil),              // 65: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.PolygonalPillar
	(*SolidModel_PolygonalPyramid)(nil),             // 66: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.PolygonalPyramid
	(*SolidModel_Column)(nil),                       // 67: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.Column
	(*SolidModel_Cone)(nil),                         // 68: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.Cone
	(*SolidModel_RightTrianglePillar)(nil),          // 69: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.RightTrianglePillar
	(*ResultPathForPlan_Path)(nil),                  // 70: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.Path
	(*ResultPathForPlan_InBarrierError)(nil),        // 71: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InBarrierError
	(*ResultPathForPlan_InNoDataError)(nil),         // 72: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InNoDataError
	(*ResultPathForPlan_NoPathError)(nil),           // 73: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.NoPathError
...
var file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_depIdxs = []int32{
	3,  // 0: trajectory.trajectory_gcs_service.protocol.v1.TransactionID.attribute:type_name -> trajectory.trajectory_gcs_service.protocol.v1.TransactionID.Attribute
	75, // 1: trajectory.trajectory_gcs_service.protocol.v1.ScheduledTime.time:type_name -> google.protobuf.Timestamp
	76, // 2: trajectory.trajectory_gcs_service.protocol.v1.ScheduledTime.period:type_name -> google.protobuf.Duration
	76, // 3: trajectory.trajectory_gcs_service.protocol.v1.ScheduledTime.occupy:type_name -> google.protobuf.Duration
	77, // 4: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Takeoff.takeoff_altitude:type_name -> trajectory.trjx_api_service.Altitude
	77, // 5: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_ROI.altitude:type_name -> trajectory.trjx_api_service.Altitude
	77, // 6: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.altitude:type_name -> trajectory.trjx_api_service.Altitude
	10, // 7: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.safety_route_attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.SafetyRoute
	58, // 8: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.heading:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.HeadingAngle
	59, // 9: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.speed:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.SpeedDef
	9,  // 10: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	36, // 11: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.camera_control:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl
	4,  // 12: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.waypoint_type:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Waypoint.Type
	77, // 13: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.altitude:type_name -> trajectory.trjx_api_service.Altitude
	10, // 14: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.safety_route_attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.SafetyRoute
	36, // 15: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.camera_control:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl
	60, // 16: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.heading:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.HeadingAngle
	61, // 17: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.speed:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_TakeoffPoint.SpeedDef
	5,  // 18: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Land.mode:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Land.LandMode
	77, // 19: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Land.approach_altitude:type_name -> trajectory.trjx_api_service.Altitude
	9,  // 20: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Land.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 21: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Speed.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 22: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Yaw.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 23: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Delay.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 24: trajectory.trajectory_gcs_service.protocol.v1.ItemParameter_Arm.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	6,  // 25: trajectory.trajectory_gcs_service.protocol.v1.ExternalMission.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ExternalMission.Format
	32, // 26: trajectory.trajectory_gcs_service.protocol.v1.ExternalMission.trjx:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission
	7,  // 27: trajectory.trajectory_gcs_service.protocol.v1.MissionControllerResult.status:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionControllerResult.Status
	8,  // 28: trajectory.trajectory_gcs_service.protocol.v1.Mission.eta_attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission.EtaAttr
	33, // 29: trajectory.trajectory_gcs_service.protocol.v1.Mission.items_array:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem
	42, // 30: trajectory.trajectory_gcs_service.protocol.v1.Mission.roi_groups:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ROI
	31, // 31: trajectory.trajectory_gcs_service.protocol.v1.Mission.app:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ApplicationAttr
	34, // 32: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.takeoff:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterTakeoff
	37, // 33: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.waypoint:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint
	38, // 34: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.land:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand
	39, // 35: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.speed:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterSpeed
	40, // 36: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.yaw:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterYaw
	35, // 37: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.roi:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterROI
	41, // 38: trajectory.trajectory_gcs_service.protocol.v1.MissionItem.delay:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterDelay
	77, // 39: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterTakeoff.altitude:type_name -> trajectory.trjx_api_service.Altitude
	77, // 40: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterROI.altitude:type_name -> trajectory.trjx_api_service.Altitude
	62, // 41: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.pitch:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.Angle
	62, // 42: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.yaw:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.Angle
	12, // 43: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.picture:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.PictureControl
	13, // 44: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.movie:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.MovieControl
	63, // 45: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.zoom:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ZoomControl
	14, // 46: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.image_mode:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ImageMode
	15, // 47: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ray_mode:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.RayMode
	77, // 48: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.altitude:type_name -> trajectory.trjx_api_service.Altitude
	10, // 49: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.safety_route_attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.SafetyRoute
	9,  // 50: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	36, // 51: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.camera_controls:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl
	16, // 52: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.waypoint_type:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterWaypoint.Type
	17, // 53: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand.mode:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand.LandMode
	78, // 54: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand.altitude_attr:type_name -> trajectory.trjx_api_service.Altitude.Standard
	9,  // 55: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterLand.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 56: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterSpeed.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 57: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterYaw.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	9,  // 58: trajectory.trajectory_gcs_service.protocol.v1.ItemParameterDelay.attr:type_name -> trajectory.trajectory_gcs_service.protocol.v1.MissionItem.ItemAttr
	79, // 59: trajectory.trajectory_gcs_service.protocol.v1.ROI.point:type_name -> trajectory.trjx_api_service.Position
	64, // 60: trajectory.trajectory_gcs_service.protocol.v1.ROI.road:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ROI.RoadROI
	75, // 61: trajectory.trajectory_gcs_service.protocol.v1.OptionalTimeStamp.time_stamp:type_name -> google.protobuf.Timestamp
	79, // 62: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.origin:type_name -> trajectory.trjx_api_service.Position
	65, // 63: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.polygonal_pillar:type_name -> trajectory.trajectory_gcs_service.protocol.v1.SolidModel.PolygonalPillar
	66, // 64: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.polygonal_pyramid:type_name -> trajectory.trajectory_gcs_service.protocol.v1.SolidModel.PolygonalPyramid
	67, // 65: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.column:type_name -> trajectory.trajectory_gcs_service.protocol.v1.SolidModel.Column
	68, // 66: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.cone:type_name -> trajectory.trajectory_gcs_service.protocol.v1.SolidModel.Cone
	69, // 67: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.right_triangle_pillar:type_name -> trajectory.trajectory_gcs_service.protocol.v1.SolidModel.RightTrianglePillar
	49, // 68: trajectory.trajectory_gcs_service.protocol.v1.Port.port:type_name -> trajectory.trajectory_gcs_service.protocol.v1.SolidModel
	80, // 69: trajectory.trajectory_gcs_service.protocol.v1.SearchSpace.max_coordinate:type_name -> trajectory.trjx_api_service.Coordinate
	80, // 70: trajectory.trajectory_gcs_service.protocol.v1.SearchSpace.min_coordinate:type_name -> trajectory.trjx_api_service.Coordinate
	1,  // 71: trajectory.trajectory_gcs_service.protocol.v1.PortLocation.interval:type_name -> trajectory.trajectory_gcs_service.protocol.v1.PortInterval
	79, // 72: trajectory.trajectory_gcs_service.protocol.v1.PortLocation.uav_position:type_name -> trajectory.trjx_api_service.Position
	79, // 73: trajectory.trajectory_gcs_service.protocol.v1.PortLocation.closest_position:type_name -> trajectory.trjx_api_service.Position
	56, // 74: trajectory.trajectory_gcs_service.protocol.v1.PortLocation.paths:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan
	2,  // 75: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.method:type_name -> trajectory.trajectory_gcs_service.protocol.v1.PlanReservationMethod
	81, // 76: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.tiles:type_name -> generic.v2.SpatialIdentification
	70, // 77: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.path:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.Path
	71, // 78: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.in_barrier_error:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InBarrierError
	72, // 79: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.in_nodata_error:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InNoDataError
	73, // 80: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.no_path_error:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.NoPathError
	74, // 81: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.unreachable_erro:type_name -> trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.UnreachableError
	79, // 82: trajectory.trajectory_gcs_service.protocol.v1.Spot.center:type_name -> trajectory.trjx_api_service.Position
	11, // 83: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.Angle.mode:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ControlMode
	11, // 84: trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ZoomControl.mode:type_name -> trajectory.trajectory_gcs_service.protocol.v1.CameraControl.ControlMode
	79, // 85: trajectory.trajectory_gcs_service.protocol.v1.ROI.RoadROI.start:type_name -> trajectory.trjx_api_service.Position
	79, // 86: trajectory.trajectory_gcs_service.protocol.v1.ROI.RoadROI.end:type_name -> trajectory.trjx_api_service.Position
	50, // 87: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.PolygonalPillar.base:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Cartesian2D
	50, // 88: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.PolygonalPyramid.base:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Cartesian2D
	50, // 89: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.Column.radii:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Cartesian2D
	50, // 90: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.Cone.radii:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Cartesian2D
	50, // 91: trajectory.trajectory_gcs_service.protocol.v1.SolidModel.RightTrianglePillar.size:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Cartesian2D
	32, // 92: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.Path.path:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission
	32, // 93: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InBarrierError.danger_path:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission
	79, // 94: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InBarrierError.position:type_name -> trajectory.trjx_api_service.Position
	32, // 95: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InNoDataError.unsafe_path:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission
	79, // 96: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.InNoDataError.position:type_name -> trajectory.trjx_api_service.Position
	32, // 97: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.NoPathError.danger_path:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission
	32, // 98: trajectory.trajectory_gcs_service.protocol.v1.ResultPathForPlan.UnreachableError.unreachable_path:type_name -> trajectory.trajectory_gcs_service.protocol.v1.Mission
...
func file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_ROI); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_TakeoffPoint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_Speed); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_Yaw); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_Delay); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_Arm); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[40].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_Waypoint_HeadingAngle); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[41].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_Waypoint_SpeedDef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[42].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_TakeoffPoint_HeadingAngle); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[43].Exporter = func(v any, i int) any {
			switch v := v.(*ItemParameter_TakeoffPoint_SpeedDef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[48].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[49].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[50].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[51].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[52].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[53].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[54].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[55].Exporter = func(v any, i int) any {
		...
		file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[56].Exporter = func(v any, i int) any {
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[4].OneofWrappers = []any{
		(*ItemParameter_Waypoint_AutoShoot)(nil),
		(*ItemParameter_Waypoint_ShootIntervalDistance)(nil),
		(*ItemParameter_Waypoint_ShootIntervalTime)(nil),
	}
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[5].OneofWrappers = []any{
		(*ItemParameter_TakeoffPoint_AutoShoot)(nil),
		(*ItemParameter_TakeoffPoint_ShootIntervalDistance)(nil),
		(*ItemParameter_TakeoffPoint_ShootIntervalTime)(nil),
	}
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[15].OneofWrappers = []any{
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[18].OneofWrappers = []any{
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[19].OneofWrappers = []any{
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[20].OneofWrappers = []any{}
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[24].OneofWrappers = []any{
		(*ROI_Point)(nil),
		(*ROI_Road)(nil),
	}
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[34].OneofWrappers = []any{}
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[35].OneofWrappers = []any{}
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[38].OneofWrappers = []any{
	...
	file_trajectory_trajectory_gcs_service_protocol_v1_resource_proto_msgTypes[39].OneofWrappers = []any{}
	type x struct{}
